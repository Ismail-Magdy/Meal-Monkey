...
class DesertDetails extends StatefulWidget {
  final String image;
  final String name;
  const DesertDetails({super.key, required this.image, required this.name});

  @override
  State<DesertDetails> createState() => _DesertDetailsState();
}

class _DesertDetailsState extends State<DesertDetails> {
  double rating = 4;
  int numberOfOrder = 0;
  bool isFav = false;
